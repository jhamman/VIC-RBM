Module P_Track
contains
SUBROUTINE Particle_Track(nr,x_head,x_bndry,dt_part,x_part,no_dt,nstrt_elm)
USE Block_Hydro
USE Block_Network
IMPLICIT NONE
integer, intent(IN):: nr
real, intent(IN):: x_head, x_bndry 
real, dimension(:):: dt_part, x_part 
integer:: n_allocate, ncell, ns, nx_part, nx_s
real:: dt_total
integer, dimension(:):: no_dt,nstrt_elm
